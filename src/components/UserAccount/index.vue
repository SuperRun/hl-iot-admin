<template>
  <el-dropdown trigger="click">
    ...
    <el-dropdown-menu slot="dropdown">
      ...
      <el-dropdown-item>
        <button type="button" class="btn-light btn" @click="openDialog">
          更改密码
        </button>
        <button type="button" class="btn-dark btn" @click="logout">
          退出登录
        </button>
      </el-dropdown-item>
    </el-dropdown-menu>
...
export default {
  ...
  methods: {
    ...
    async logout() {
      ...
      this.$store.commit('project/SET_PROJLIST', []);
      this.$store.commit('project/SET_CURPROJ', '');
