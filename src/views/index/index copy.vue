        ...
        <div class="flex-1 equips" v-show="!isFold">
          <ul class="flex">
            ...
            >
              <img
                :src="
                  require(`@/assets/images/control${
                    currentTab.includes(1) ? '-active' : ''
                  }.png`)
                "
                alt
              />
            ...
            >
              <img
                :src="
                  require(`@/assets/images/screen${
                    currentTab.includes(2) ? '-active' : ''
                  }.png`)
                "
                alt
              />
            ...
            >
              <img
                :src="
                  require(`@/assets/images/detect${
                    currentTab.includes(4) ? '-active' : ''
                  }.png`)
                "
                alt
              />
