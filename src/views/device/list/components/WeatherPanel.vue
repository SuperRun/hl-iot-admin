<template>
  <div class="weather-panel">
    ...
    <!-- 地图 -->
    <div class="weather-map" v-show="tableOrMap=='map'">
      <div id="weather-map"></div>
      <i :class="[`el-icon-${isLock?'':'un'}lock`, 'lock']" @click="lock"></i>
    </div>
    <!-- 弹出框 -->
    <el-dialog title="添加设备(气象站)" :visible.sync="showDialog" center @opened="dialogOpened">
...
export default {
  ...
  methods: {
    ...
    lock() {
      ...
      this.isLock
        ? this.weatherMap.disableMarksDragging()
        : this.weatherMap.enableMarksDragging();
    }
  }
};
</script>
