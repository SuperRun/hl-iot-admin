<template>
  <div class="camera-panel">
    ...
    <!-- 地图 -->
    <div class="device-map" v-show="tableOrMap == 'map'">
    ...
    >
      <el-form :model="model" :inline="true" :rules="rules" ref="form">
        ...
        <el-form-item
          label="网关"
          :label-width="formLabelWidth"
          prop="gateway_device_id"
        >
          <el-select v-model="model.gateway_device_id" placeholder="请选择网关">
            <el-option
              :key="gateway.id"
              :label="`${gateway.device_number}(${gateway.place_number})`"
              :value="gateway.id"
        ...
        >
          <el-input
            v-model="model.validate_code"
            maxlength="6"
            show-word-limit
            @input="model.validate_code = model.validate_code.toUpperCase()"
          ></el-input>
        </el-form-item>
        <br />
        <el-form-item
